...
describe('DestinationsService', () => {
  ...
  describe('create', () => {
    ...
    it('should save destination description with empty properties when AI generation fails', async () => {
    ...
    it('should create a destination description with AI auto-generating text if description property is not provided', async () => {
